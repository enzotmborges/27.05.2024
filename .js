...
var pessoa = [];
pessoa[0] = new Pessoa("", "magro", "17", "53kg", "roxo", "", "172cm", "", "takashi");
pessoa[1] = new Pessoa("", "", "", "", "", "", "", "", "tiago");
pessoa[2] = new Pessoa("", "", "", "", "", "", "", "", "raissa");
pessoa[3] = new Pessoa("", "", "", "", "", "", "", "", "julia");
pessoa[4] = new Pessoa("", "", "", "", "", "", "", "", "aleciane");

var musica = [];
musica[0] = new Musica("", "", "", "Ana Castela, DENNIS e MC GW", "ram tchu");
musica[1] = new Musica("", "", "", "Ana Castela", "nao para");
...
var local_do_ensaio = [];
local_do_ensaio[0] = new LocalDoEnsaio();

var banheiro = [];
banheiro[0] = new Banheiro();
banheiro[1] = new Banheiro();